(function($) {
    ...
    $.fn.responsivenav = function(args) {
        var defaults = { responsive: true, width: 993, button: $(this).attr('id')+'-button', animation: { effect: 'slide', show: 150, hide: 100 }, selected: 'selected', arrow: 'downarrow' };
        ...
        function resizeMenu(menuid, buttonid) { /* CÓDIGO COMPLETO AQUI */ }
        function collapseChildren(elementid) { /* CÓDIGO COMPLETO AQUI */ }
        function isSelected(element) { /* CÓDIGO COMPLETO AQUI */ }
        function animateShow(menu, button) { /* CÓDIGO COMPLETO AQUI */ }
        function animateHide(menu, button) { /* CÓDIGO COMPLETO AQUI */ }
    };
