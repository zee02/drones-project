    ...
    <div class="container">
        ...
        <nav id="primary-nav" class="dropdown cf">
            <ul class="dropdown menu">
                <li>
                    <a href="<?php echo e(route('solucoes', array_merge($params, ['locale' => $currentLocale]))); ?>">
                        <?php echo e(__('messages.nav.solucoes')); ?>

                    </a>
                </li>
                <li><a href="#"><?php echo e(__('messages.nav.produtos')); ?></a></li>
                <li>
                    <a href="<?php echo e(route('servicos', array_merge($params, ['locale' => $currentLocale]))); ?>">
                        <?php echo e(__('messages.nav.servicos')); ?>
